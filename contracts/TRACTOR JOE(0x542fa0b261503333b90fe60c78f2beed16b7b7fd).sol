...
//  | | |   /  / _ \  | (__  | |  | (_) |   /  | || | (_) | _|  
//  |_| |_|_\ /_/ \_\  \___| |_|   \___/|_|_\   \__/ \___/|___|
  
  
//  Tokenomics:
//  4% of transactions to burn wallet (BUYBACK JOE AND BURN)
//  LP tax and reflection disabled.
...
abstract contract Ownable is Context {
    ...
    constructor () {
        ...
        _owner = 0x7b87848426d47e6B9CF6BC7550Cb7Bf917e08965;
...
contract TRACTOR is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0x4F6787542CdA0e70e8827196805D346CB066cbAD;
   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**9; //Total supply
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "TRACTOR JOE";
    string private _symbol = "TRACTOR";
    ...
    uint256 public _maxTxAmount = 1000000000 * 10**9; //Max tx amount
    uint256 private numTokensSellToAddToLiquidity = 500000 * 10**9; //Fee threshold for LP acquisition
